...
mvn -s /maven-settings.xml -f ${GITHUB_WORKSPACE}/${INPUT_PROJECT_NAME}/poms/pom.xml -Pcloud-publisher clean deploy -e -pl jobs/process/${INPUT_JOB_NAME}_${INPUT_JOB_VERSION} -am
